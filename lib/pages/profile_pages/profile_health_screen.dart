...
class ProfileHealth extends StatelessWidget {
  const ProfileHealth({super.key});
        ...
        child: SingleChildScrollView(
          child:  Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                'Alerjen besinleri işaretleyiniz.',
                style: TextStyle(
                    fontSize: 18,
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Center(
                              child: Image.asset(
                                'assets/images/profile_health_images/${img1[j]}.png',
                                width: 45,
                                height: 45,
                                fit: BoxFit.cover,
                              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Center(
                              child: Image.asset(
                                'assets/images/profile_health_images/${img2[j]}.png',
                                width: 45,
                                height: 45,
                                fit: BoxFit.cover,
                              ),
              ...
              SizedBox(height: 20),
              Text(
                'Rahatsızlıklarınızı işaretleyiniz.',
                style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.w300
                ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Center(
                              child: Image.asset(
                                'assets/images/profile_health_images/${img3[j]}.png',
                                width: 80,
                                height: 80,
                                fit: BoxFit.cover,
                              ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                            child: Center(
                              child: Image.asset(
                                'assets/images/profile_health_images/${img4[j]}.png',
                                width: 70,
                                height: 70,
                                fit: BoxFit.cover,
                              ),
